...
- `operation-id-client.mjs`: call any cataloged HTTP primitive by stable operation id, with path/query/body options and shared SDK request/response validation.
