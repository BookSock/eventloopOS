...
| Browser extension allowlist | `pnpm --filter @eventloopos/browser-extension test` | Capture/restore/polling skips disallowed domains and works for allowed domains from options/config | Run before real private-browser dogfood. |
