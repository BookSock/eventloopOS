...
| Current paper briefing remains visible | Queue detail begins with `queue-paper-briefing-strip`, backed by `QueuePaperBriefingPresentation` tests and Swift render smoke screenshots | Proven |
