...
- Latest readiness screenshot: `artifacts/lab-runs/20260606T031258Z-human-demo-ready/captures/human-demo-ready/screen.png`
- Latest readiness manifest: `artifacts/lab-runs/20260606T031258Z-human-demo-ready/manifest.json`
...
| Visible feedback during demo | Queue footer `feedback=...`; top HUD transient hotkey feedback; `QueueHarnessStatusTextTests`; `AdvanceToastBannerPresentationTests`; `QueueViewModelTests` post-action lease-conflict coverage proves Done/Defer/Send show saved-action feedback instead of surfacing 409 noise; latest screenshot shows `feedback=Showing paper...`; latest readiness proves Queue feedback in 123 ms p95 and top HUD restore feedback in 155 ms p95 | Proven |
