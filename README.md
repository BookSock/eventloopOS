...
[![macOS App](https://github.com/BookSock/eventloopOS/actions/workflows/macos-app.yml/badge.svg?branch=main)](https://github.com/BookSock/eventloopOS/actions/workflows/macos-app.yml)
